...
- [x] Update github workflows to fix this issue: `Error: This request has been automatically failed because it uses a deprecated version of `actions/cache: v2`. Please update your workflow to use v3/v4 of actions/cache to avoid interruptions. Learn more: https://github.blog/changelog/2024-12-05-notice-of-upcoming-releases-and-breaking-changes-for-github-actions/#actions-cache-v1-v2-and-actions-toolkit-cache-package-closing-down`
 (use branch bug/gh-workflows, create PR)
  - [x] Update deprecated action versions (cache@v2, checkout@v2, setup-node@v2) to current versions in both workflow files, commit & push
  - [x] Create PR from bug/gh-workflows to master

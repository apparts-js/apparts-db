...
4. **Check for correctness gotchas.** Beyond missing tests, look for tests that exist but are subtly wrong and won't actually catch bugs. See `.opencode/skills/verify-tests/references/gotchas.md` for known patterns specific to this codebase.
